...
const data = [
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2023-08-06 03:30:00",
        opened: true,
      },
      badges: {
        textExtendedBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2023-08-06 05:05:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2023-08-05 22:40:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2023-08-06 00:55:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
    ...
    <div id="headerCnt" className="header-cnt">
      <div id="logo" className="header-logo">
        <img
          ...
          src="https://i.postimg.cc/sf4HHdtK/Screenshot-from-2023-08-05-19-39-58.png"
          alt="Bite Express"
        />
      </div>
...
const RestaurantCard = (props) => {
  ...
  return (
    <div id="resCard" className="res-card">
      ...
      <span><h3>{data.cuisines.join(', ')}</h3></span>
      <h4>{data.areaName}</h4>
    </div>
  );
};
